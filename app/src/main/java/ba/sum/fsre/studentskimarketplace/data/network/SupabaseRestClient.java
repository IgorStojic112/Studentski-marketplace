...
public class SupabaseRestClient {
    ...
    public void delete(String path, Map<String, String> query, Callback cb) {
        delete(path, query, null, cb);
    }
    ...
    public void getRaw(String fullUrl, String accessToken, Callback cb) {
        Request.Builder req = baseRequest(fullUrl, accessToken).get();
        http.newCall(req.build()).enqueue(cb);
    }
